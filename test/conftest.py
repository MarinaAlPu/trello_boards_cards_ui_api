...
@pytest.fixture
def lists_on_board(api_client: BoardAPI, dummy_board_id: str) -> dict:
    # lists = {
    #     'list_one_id': '',
    #     'list_two_id': '',
    #     'list_three_id': ''
...
# @pytest.fixture
# def list_one_id(api_client: BoardAPI, lists_on_board: dict) -> str:
#     return lists_on_board["list_one_id"]
...
# @pytest.fixture
# def move_card(api_card_client: CardAPI, lists_on_board: dict, ) -> str:
#     lists_on_board
#     list_one_id = lists_on_board[0]["id"]
#     list_two_id = lists_on_board[1]["id"]
