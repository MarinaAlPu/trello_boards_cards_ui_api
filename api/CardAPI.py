...
#     def get_cards_by_list_id(self, id: str) -> list:
#         path = "{trello}/lists/{list_id}/cards".format(trello = self.base_url, list_id = id)
#         print("\nURL для получения списка карточек в колонке " + path)

#         cookie = {"token": '6410e3061677ca07e152a914/ATTSErkH1NWoupUXCMttfF52OxV36yw7Dl1xyoemvFIOi1msR7kG77Ef8tvonVIO4C7T8387F93E'}
#         resp = requests.get(path, json = cookie, cookies = cookie)
#         print("\nответ на получение списка карточек в колонке: ")
#         print(resp)

#         return resp.json()  
    
#     # @allure.step("Добавить карточку {name} в колонке") # название или id колонки?
#     # def create_card(self, list_id: str, name: str) -> dict:
#     #     # print("\nlists_id на входе в методе create_card: ")
#     #     # print(lists_id)
...
#     #     cookie = {"token": self.token}
#     #     resp = requests.post(path, json = body, cookies = cookie)
#     #     print("\n ответ на post-запрос на создание карточки в методе create_card в файле CardAPI")
#     #     print(resp)
#     #     return resp.json()        
...
#     @allure.step("Переместить карточку {id} на другой лист с id {list_id}")    
#     def move_one_card(self, id: str, list_id: str) -> dict:
